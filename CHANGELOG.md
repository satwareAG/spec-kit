...
- **Junie Agent Support**: Added support for the JetBrains Junie AI agent.
  - Added `junie` to `AGENT_CONFIG` using `.junie/commands/` directory.
  - Updated all initialization and release scripts to support the new agent.
  - Updated documentation (`README.md`, `AGENTS.md`) to include Junie as a supported agent.
